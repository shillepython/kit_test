    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down blue-grey darken-4 white-text">
                <li><a class="white-text" href="/resources/views/account/hub-test">На главную</a></li>
            ...
            <ul id="dropdown1" class="dropdown-content blue-grey darken-4 white-text class="white-text"">
                <li><a class="white-text" href="/resources/views/account/profile">Профиль</a></li>
                <li><a class="white-text" href="?out">Выход</a></li>
            </ul>
        </div>
